...
const createCredential = (createCredentialDto) => __awaiter(void 0, void 0, void 0, function* () {
    const newCredential = yield data_source_1.CredentailsModel.create(createCredentialDto);
    const result = yield data_source_1.CredentailsModel.save(newCredential);
    return newCredential;
});
exports.createCredential = createCredential;
const validateCredential = (validateCredentialDto) => __awaiter(void 0, void 0, void 0, function* () {
    const { username, password } = validateCredentialDto;
    const foundCredential = yield data_source_1.CredentailsModel.findOneBy({
        username,
    });
    if (!foundCredential)
